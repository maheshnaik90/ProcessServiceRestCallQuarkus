...
import com.example.ProductModelOutput;
...
public class ProductResource {
    ...
    public Response createResource_product(@Context HttpHeaders httpHeaders, @Context UriInfo uriInfo, @QueryParam("businessKey") String businessKey, @javax.validation.Valid() @javax.validation.constraints.NotNull() ProductModelInput resource) {
        return UnitOfWorkExecutor.executeInUnitOfWork(application.unitOfWorkManager(), () -> {
            ProductModelInput inputModel = resource != null ? resource : new ProductModelInput();
            ProcessInstance<ProductModel> pi = process.createInstance(businessKey, inputModel.toModel());
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public List<ProductModelOutput> getResources_product() {
    ...
    @Path("/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public ProductModelOutput getResource_product(@PathParam("id") String id) {
    ...
    @Path("/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public ProductModelOutput deleteResource_product(@PathParam("id") final String id) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public ProductModelOutput updateModel_product(@PathParam("id") String id, ProductModel resource) {
    ...
    @Path("/{id}/tasks")
    @Produces(MediaType.APPLICATION_JSON)
    public List<WorkItem> getTasks_product(@PathParam("id") String id, @QueryParam("user") final String user, @QueryParam("group") final List<String> groups) {
